...
export const DEPLOYMENT_PROFILES = Object.freeze({
  ...
  BIFROST_VIA_MOONBASE_ALPHA: "bifrost-via-moonbase-alpha",
...
const DEPLOYMENT_PROFILE_ALIASES = Object.freeze({
  ...
  "bifrost-via-moonbeam": DEPLOYMENT_PROFILES.BIFROST_VIA_MOONBASE_ALPHA,
  "bifrost-via-moonbase": DEPLOYMENT_PROFILES.BIFROST_VIA_MOONBASE_ALPHA,
  "bifrost-via-moonbeam-testnet": DEPLOYMENT_PROFILES.BIFROST_VIA_MOONBASE_ALPHA,
